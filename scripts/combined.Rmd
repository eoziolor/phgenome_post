...
fai<-read.csv("~/phgenome_post/data/arks/phgenome.hap_c5_m50-6000_k30_r0.05_e30000_z500_l5_a0.9.scaffolds",header=FALSE,stringsAsFactors = FALSE) #reading in fai file produced from arks
...
sum(head(fai_10.1[,2],n=221))/1000000
fai_10.1[221,2]/1000000
...
fai<-read.csv("~/phgenome_post/data/arks/arks1_c5_m50-10000_k30_r0.05_e30000_z500_l5_a0.3.scaffolds",header=FALSE,stringsAsFactors = FALSE) #reading in fai file produced from arks
...
#calculating N50
(sum(fai_10.1[,2])/1000000)/2
sum(head(fai_10.1[,2],n=215))/1000000
fai_10.1[215,2]/1000000
...
#calculating N50
(sum(fai_10.1[,2])/1000000)/2
sum(head(fai_10.1[,2],n=198))/1000000
fai_10.1[198,2]/1000000
...
#calculating N50
(sum(fai_10.1[,2])/1000000)/2
sum(head(fai_10.1[,2],n=165))/1000000
fai_10.1[165,2]/1000000
```
...
#calculating N50
(sum(fai_10.1[,2])/1000000)/2
sum(head(fai_10.1[,2],n=113))/1000000
fai_10.1[113,2]/1000000
```
...
#calculating N50
(sum(fai_10.1[,2])/1000000)/2
sum(head(fai_10.1[,2],n=102))/1000000
fai_10.1[102,2]/1000000
```
